...
```{r, fig.height=8, fig.width=9, fig.fullwidth=TRUE, fig.caption="Normalised frequency counts for all responses, ordered from the highest number of Agree/Strongly Agree responses to the least. Includes response rates (n) for each question."}
...
```{r, fig.height=8, fig.width=9, fig.fullwidth=TRUE, fig.caption="TO DO"}
all_staff <- lkt[,2] == "All staff"
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I enjoy AC staff camps\"", echo=FALSE}
q <- 4
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
```
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"AC graduation and other public events are run well\"", echo=FALSE}
q <- 5
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I feel valued by my manager for the work I do\"", echo=FALSE}
q <- 6
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I feel valued by my peers for the work I do\"", echo=FALSE}
q <- 7
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I feel I have the skills to do the job I've been asked to do\"", echo=FALSE}
q <- 8
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I have a clear understanding of the AC organisational structure\"", echo=FALSE}
q <- 9
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I feel I fit into the organisational culture of AC\"", echo=FALSE}
q <- 10
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I attend Chapel because I want to, not because I have to\"", echo=FALSE}
q <- 11
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"The mission and vision of the College has been clearly communicated to me\"", echo=FALSE}
q <- 12
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I consider my office area and staff facilities adequate in order to perform my duties\"", echo=FALSE}
q <- 13
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
```{r, fig.height=2.5, fig.width=9, fig.fullwidth=TRUE, fig.cap = "Frequency table visualisation for \"I am likely to recommend AC as an employer of choice\"", echo=FALSE}
q <- 14
q_lkt <- likert(lkt[q], grouping = lkt[,2]) # Group q responses by staff type
plot(q_lkt, text.size=3, include.histogram=TRUE, plot.percent.neutral=FALSE,
     group.order=c('All staff', 'Academia', 'Administration'))
...
Table: Main reasons Academic and Administrative staff choos to work at AC.
